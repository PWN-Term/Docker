...
func TestContainerNetworkMountsNoChown(t *testing.T) {
	...
	hostConfig := containertypes.HostConfig{
		Mounts: []mounttypes.Mount{
			...
			},
			{
				Type:   "bind",
				Source: tmpNWFileMount,
				Target: "/data/data/hilled.pwnterm/files/usr/etc/hosts",
			},
		},
	}
	...
	// (/data/data/hilled.pwnterm/files/usr/etc/resolv.conf, /data/data/hilled.pwnterm/files/usr/etc/hosts, /etc/hostname) separately from the
